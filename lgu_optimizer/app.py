...
function renderResults(data) {
  ...
  const ccards = results.map((r,ri)=>{
    ...
    return `<div class="ccard ${isBest?'best':''}">
      ...
      <div class="ccard-row"><span class="lbl">Pruning Rate</span><span class="val ${r.pruning_rate!=null?'hl-green':''}">${r.pruning_rate!=null ? r.pruning_rate.toFixed(2)+'%' : 'N/A'}</span></div>
